...
To illustrate a basic example, I look at data concerned with a commodity that certainly had its share of consumption growth during the quarantine period: Wine. I have chosen to keep the explanations high-level but do check out my [GitHub](https://github.com/ndleah/wine-quality-coufounding-variables) repository to view the detailed analysis and code in my R Scripts. 
